// (var (root, factory) {
//     if (typeof define === 'var' && define.amd) {
...
var d3_layout_flextree = () => {
  ...
  var nextLeftContour = (wt) => {
    return wt.num_children == 0 ? wt.tl : wt.children[0];
  }
    
  var nextRightContour = (wt) => {
  ...
  var setLeftThread = (wt, i, cl, modsumcl) => {
  ...
  var setRightThread = (wt, i, sr, modsumsr) => {
  ...
  var distributeExtra = (wt, i, si, dist) => {
  ...
  var renormalize = (wt) => {
    ...
    // Else either a fixed node size, or node size var was specified.
...
var d3_layout_treeSeparation = (a, b) => {
  return a.parent == b.parent ? 1 : 2;
}
var d3_layout_hierarchyRebind = (object, hierarchy) => {
...
var d3_layout_hierarchyLinks = (nodes) => {
  return d3.merge(nodes.map((parent) => {
...
// }));
export default d3_layout_flextree;
